...
const lines = [
  ...
  { text: "- Worked on 30+ projects and built selected e-commerce, dashboard, job portal, and service management apps.", size: 8.7, font: "F1", x: 64, y: 412 },
  ...
  { text: "- Practiced full stack and AI-assisted workflows with React, Node.js, APIs, MongoDB/MySQL, GitHub, and Vercel.", size: 8.7, font: "F1", x: 64, y: 388 },
