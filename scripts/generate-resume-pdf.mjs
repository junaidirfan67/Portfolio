...
const lines = [
  ...
  { text: "Hands-on with role-based dashboards, booking flows, job portals, marketplace portfolios, REST APIs, and databases.", size: 9.2, font: "F1", x: 54, y: 622 },
  { text: "Comfortable preparing client-ready UI, live demos, GitHub repositories, and Vercel/GitHub Pages deployment.", size: 9.2, font: "F1", x: 54, y: 610 },
  ...
  { text: "- Built and deployed React portfolio, dashboard, job portal, and service management projects.", size: 8.7, font: "F1", x: 64, y: 412 },
