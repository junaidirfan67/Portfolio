...
const lines = [
  ...
  { text: "Live: autotechmanagementsystem.vercel.app | Code: github.com/Ali-Jun/AutoTechmanagementsystem", size: 8, font: "F1", x: 64, y: 280 },
  ...
  { text: "Live: lnkd.in/da95uY8H | Code: lnkd.in/dUQmbrYE", size: 8.3, font: "F1", x: 64, y: 238 },
